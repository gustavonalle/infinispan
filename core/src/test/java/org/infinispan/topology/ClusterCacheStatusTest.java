...
public class ClusterCacheStatusTest extends AbstractInfinispanTest {
   ...
   public void setup() {
      ...
      status = new ClusterCacheStatus(cacheManager, CACHE_NAME, availabilityStrategy,
                                      topologyManager, transport, Optional.empty(), persistentUUIDManager, false);
   }
   ...
   public void testQueueRebalanceSingleNode() throws Exception {
      ...
      verify(topologyManager, atLeastOnce()).isRebalancingEnabled();
