...
public interface InfinispanLogger extends BasicLogger {
   ...
   void deprecatedAttribute(String attribute);
   ...
   @LogMessage(level = WARN)
   @Message(id = 25, value = "IndexMode is deprecated and is automatically detected when indexing is enabled. Please replace this attribute with \"enabled='true'\"")
