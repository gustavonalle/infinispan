package org.infinispan.commons.dataconversion.impl;
...
public class Json implements java.io.Serializable {
   ...
   static class ObjectJson extends Json {
      ...
      public static void main(String[] args) {
         String raw = "{ \"a\": 1 , \"b\":{ \"c\":[1] }}";
         String raw2 = "[ 1,2,34]";
         Json set = Json.object().set("root", Json.object().set("field1", "value1").set("raw2", factory().raw(raw2)).set("conf", Json.factory().raw(raw)));
