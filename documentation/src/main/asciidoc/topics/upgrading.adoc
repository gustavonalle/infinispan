...
* `org.infinispan.commons.dataconversion.Encoder` has been deprecated and will be removed in a future version. All data conversions
for a cache must be done using a `org.infinispan.commons.dataconversion.Transcoder` instead.
