...
public class CorsHandler extends ChannelDuplexHandler {
   ...
   private static final Pattern SCHEME_PATTERN = Pattern.compile("^[Hh][Tt][Tt][Pp][Ss]?://");
   ...
   private boolean allowRequest(String origin) {
      ...
      String originDomain = SCHEME_PATTERN.matcher(origin).replaceFirst("");

      // If it's a same origin request, allow it to proceed.
      return originDomain.equals(request.headers().get(HttpHeaderNames.HOST));
   }
