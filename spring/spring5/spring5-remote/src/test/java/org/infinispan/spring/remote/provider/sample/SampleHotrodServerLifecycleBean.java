...
public class SampleHotrodServerLifecycleBean implements InitializingBean, DisposableBean {
   ...
   public void afterPropertiesSet() throws Exception {
      ...
      cacheManager.defineConfiguration(remoteCacheName, builder.build());
      cacheManager.defineConfiguration(remoteBackupCacheName, builder.build());
      cacheManager.defineConfiguration(customCacheName, builder.build());
