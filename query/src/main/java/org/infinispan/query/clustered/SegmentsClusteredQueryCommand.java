 ...
 * @since 10.1
 */
public class SegmentsClusteredQueryCommand extends BaseRpcCommand implements CustomQueryCommand {
   ...
   public ClusteredQueryOperation getClusteredQueryOperation() {
      return clusteredQueryOperation;
   }

   public void setClusteredQueryOperation(ClusteredQueryOperation clusteredQueryOperation) {
      this.clusteredQueryOperation = clusteredQueryOperation;
   }
