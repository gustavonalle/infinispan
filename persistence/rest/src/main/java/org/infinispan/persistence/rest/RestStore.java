...
public class RestStore<K, V> implements AdvancedLoadWriteStore<K, V> {
   ...
   public void start() {
      ...
      cacheClient = client.cache(configuration.cacheName());
   ...
   public boolean isAvailable() {
      try {
         ...
         RestResponse response = CompletableFutures.await(exists.toCompletableFuture());
   ...
   public void write(MarshallableEntry entry) {
      try {
         ...
         RestResponse response = CompletableFutures.await(req.toCompletableFuture());
   ...
   public void clear() {
      try {
         ...
         RestResponse response = CompletableFutures.await(clear.toCompletableFuture());
   ...
   public boolean delete(Object key) {
      try {
         ...
         RestResponse response = CompletableFutures.await(remove.toCompletableFuture());
   ...
   public Flowable<K> publishKeys(Predicate<? super K> filter) {
      return Flowable.using(() -> {
         RestResponse response = CompletableFutures.await(cacheClient.keys().toCompletableFuture());
   ...
   public int size() {
      try {
         RestResponse response = CompletableFutures.await(cacheClient.size().toCompletableFuture());
